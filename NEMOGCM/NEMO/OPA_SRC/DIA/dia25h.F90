MODULE dia25h 
   ...
   USE fabm, ONLY: fabm_get_interior_diagnostic_data, &
...
# if defined key_zdfgls
      ...
      END DO
      DO jn = 1, jp_fabm_3d
         fabm_3d_25h(:,:,:,jn) = fabm_get_interior_diagnostic_data(model, jn)
      END DO
...
# if defined key_zdfgls
      ...
      END DO
      DO jn = 1, jp_fabm_3d
         fabm_3d_25h(:,:,:,jn) = fabm_3d_25h(:,:,:,jn) + fabm_get_interior_diagnostic_data(model, jn)
      END DO
      DO jn = 1, jp_fabm_surface
